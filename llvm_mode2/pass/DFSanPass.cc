...
bool DataFlowSanitizer::doInitialization(Module &M) {
  ...
  //ShadowPtrTy->print(errs()); errs() << " <-- shadowptrty\n"; i32*Ty
...
bool DataFlowSanitizer::runOnModule(Module &M) {
  //errs() << "Start running on module DFSan\n";
  ...
  //errs() << "Finished running on module DFSan\n");
  return false;
}
...
Value *DFSanFunction::combineShadows(Value *V1, Value *V2, Instruction *Pos) {
  ...
  case Instruction::And:
    if (Pos->getNumOperands() == 2) {
      ...
      //errs() << "V1 "; V1->getType()->print(errs()); errs() << "\n";
      //errs() << "V2 "; V2->getType()->print(errs()); errs() << "\n";
      //errs() << *Pos << "\n";
      /*for(auto arg = ((Function*)&*DFS.DFSanCombineAndFn)->arg_begin(), argE = ((Function *)&*DFS.DFSanCombineAndFn)->arg_end(); 
        arg!=argE; ++arg) {
      ...
      if (Arg1->getType()->isIntegerTy() && Arg2->getType()->isIntegerTy()) {
        //errs() << "here\n";
        IRBuilder<> IRB(Pos);
        if (isa<ConstantInt>(Arg1) && V2 != DFS.ZeroShadow && 
           V2->getType() == PointerType::getInt32PtrTy(C)) { // Constant
          ...
          Call->addAttribute(0, Attribute::ZExt);
           ...
           V1->getType() == PointerType::getInt32PtrTy(C)) {
  ...
  case Instruction::SRem:
    ...
    if (num_bytes > 0 && num_bits % 8 == 0) {
      //errs() << "it goes to Instruction::SRem\n";
  ...
  IRBuilder<> IRB(Pos);
  if (AvoidNewBlocks) {
    //errs() << "it goes to AvoidNewBlocks\n";
