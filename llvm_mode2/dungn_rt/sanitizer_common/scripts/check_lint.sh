...
DUNGN_RTL_LINT_FILTER=${COMMON_LINT_FILTER},-runtime/int,-runtime/printf,-runtime/references,-readability/function
...
# Dungn
DUNGN_RTL=${COMPILER_RT}/lib/dungn
run_lint ${DUNGN_RTL_LINT_FILTER} ${DUNGN_RTL}/*.cc \
                                  ${DUNGN_RTL}/*.h &
${DUNGN_RTL}/scripts/check_custom_wrappers.sh >> $ERROR_LOG
