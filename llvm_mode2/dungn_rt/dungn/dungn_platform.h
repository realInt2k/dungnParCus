...
//
// Platform specific information for Dungn.
//===----------------------------------------------------------------------===//

#ifndef DUNGN_PLATFORM_H
#define DUNGN_PLATFORM_H
...
extern int vmaSize;
# define DUNGN_RUNTIME_VMA 1
#else
# error "Dungn not supported for this platform!"
#endif
