...
AIBAR_RTL_LINT_FILTER=${COMMON_LINT_FILTER},-runtime/int,-runtime/printf,-runtime/references,-readability/function
...
# Dungn
AIBAR_RTL=${COMPILER_RT}/lib/aibar
run_lint ${AIBAR_RTL_LINT_FILTER} ${AIBAR_RTL}/*.cc \
                                  ${AIBAR_RTL}/*.h &
${AIBAR_RTL}/scripts/check_custom_wrappers.sh >> $ERROR_LOG
